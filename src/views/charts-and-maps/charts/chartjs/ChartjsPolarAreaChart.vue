...
<template>
  <vx-card title="Polar Area Chart" class="mb-base" code-toggler>
    ...
    <template slot="codeContainer">
      &lt;script&gt; import { PolarArea } from 'vue-chartjs' export default {
      ...
      title: { display: true, text: 'Predicted world population (millions) in
      2050' } } } } mounted () { this.renderChart(this.data, this.options) } }
      &lt;/script&gt;
    </template>
  </vx-card>
</template>
