...
<template>
  <vx-card title="Array Values" code-toggler>
    <span
      ...
      <code>v-model</code> with a value of <strong>array</strong>.</span
    >
    ...
    <template slot="codeContainer">
      ...
      vs-value=&quot;luis&quot;&gt;Luis&lt;/vs-checkbox&gt; &lt;/li&gt;
      &lt;li&gt; &lt;vs-checkbox v-model=&quot;checkBox1&quot;
      vs-value=&quot;carols&quot;&gt;Carols&lt;/vs-checkbox&gt; &lt;/li&gt;
      &lt;li&gt; &lt;vs-checkbox v-model=&quot;checkBox1&quot;
      vs-value=&quot;summer&quot;&gt;Summer&lt;/vs-checkbox&gt; &lt;/li&gt;
      &lt;li&gt; &lt;vs-checkbox v-model=&quot;checkBox1&quot;
      vs-value=&quot;lyon&quot;&gt;Lyon&lt;/vs-checkbox&gt; &lt;/li&gt; &lt;li
      class=&quot;modelx&quot;&gt;
      {{ "\{\{ checkBox1 \}\}" }}
      &lt;/li&gt; &lt;/ul&gt; &lt;/template&gt; &lt;script&gt; export default {
      data() { return { checkBox1: [&apos;luis&apos;] } } } &lt;/script&gt;
    </template>
  </vx-card>
</template>
