...
<template>
  <vx-card title="Array Object values" code-toggler>
    <span
      >Sometimes you need to link an object as a value when selecting a checkBox
      for it, you only have to put it as value in <strong>vs-value</strong> an
      object either literal or linked.</span
    >
    ...
    <template slot="codeContainer">
      ...
      :vs-value=&quot;region&quot; &gt;{{
        "\{\{ region.name \}\}"
      }}&lt;/vs-checkbox&gt; &lt;/li&gt; &lt;/ul&gt; &lt;div
      class=&quot;modelx&quot;&gt;{{ "\{\{ form.regions \}\}" }}&lt;/div&gt;
      &lt;/template&gt; &lt;script&gt; export default { data: () =&gt; ({ form:
      { regions: [] }, regions: [ { id: 1, name: &apos;Queensland&apos; }, { id:
      2, name: &apos;South Australia&apos; }, { id: 3, name: &apos;New South
      Wales&apos; }, ] }) } &lt;/script&gt;
    </template>
  </vx-card>
</template>
