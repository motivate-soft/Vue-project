...
<template>
  <vx-card title="Width" code-toggler>
    <span
      >You can set the width of the textarea with the
      <code>width</code> prop.</span
    >
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;div&gt; &lt;vs-textarea v-model=&quot;textarea&quot;
      label=&quot;Height set to 300px&quot; width=&quot;300px&quot; /&gt;
      &lt;/div&gt; &lt;/template&gt; &lt;script&gt; export default {
      data:()=&gt;({ textarea: &apos;&apos;, }) } &lt;/script&gt;
    </template>
  </vx-card>
</template>
