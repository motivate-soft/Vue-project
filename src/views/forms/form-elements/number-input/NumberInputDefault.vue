...
<template>
  <vx-card title="Default" code-toggler>
    <p>
      ...
      component <code>vs-input-number</code>
    </p>
    <p>
      You can also change the increment and decrement button icons using the
      properties <code>icon-inc</code> and <code>icon-dec</code> respectively
    </p>
