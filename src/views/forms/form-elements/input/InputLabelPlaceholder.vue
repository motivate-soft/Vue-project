...
<template>
  <vx-card title="Label Placeholder" code-toggler>
    <span
      >The placeholder can become a label when the input is focused. Use the
      property <code>label-placeholder</code> for making this.</span
    >
    ...
    <template slot="codeContainer">
      ...
      class=&quot;centerx&quot;&gt; &lt;vs-input
      label-placeholder=&quot;Label-placeholder&quot;
      v-model=&quot;value1&quot;/&gt; &lt;vs-input disabled=&quot;true&quot;
      label-placeholder=&quot;Label-placeholder-disabled&quot;
      v-model=&quot;value2&quot;/&gt; &lt;/div&gt; &lt;/template&gt;
