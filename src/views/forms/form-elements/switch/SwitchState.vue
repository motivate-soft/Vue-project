...
<template>
  <vx-card title="State" code-toggler>
    ...
    <template slot="codeContainer">
      &lt;template lang=&quot;html&quot;&gt; &lt;ul
      class=&quot;switch-container&quot;&gt; &lt;li&gt; &lt;label&gt;true /
      active&lt;/label&gt; &lt;vs-switch v-model=&quot;switch1&quot; /&gt;
      &lt;/li&gt; &lt;li&gt; &lt;label&gt;false / inactive&lt;/label&gt;
      &lt;vs-switch v-model=&quot;switch2&quot; /&gt; &lt;/li&gt; &lt;li&gt;
      &lt;label&gt;disabled / active&lt;/label&gt; &lt;vs-switch
      disabled=&quot;true&quot; v-model=&quot;switch3&quot; /&gt; &lt;/li&gt;
      &lt;li&gt; &lt;label&gt;disabled / inactive&lt;/label&gt; &lt;vs-switch
      disabled=&quot;true&quot; v-model=&quot;switch4&quot; /&gt; &lt;/li&gt;
      &lt;/ul&gt; &lt;/template&gt; &lt;script&gt; export default { data(){
      return { switch1:true, switch2:false, switch3:true, switch4:false, } } }
      &lt;/script&gt;
    </template>
  </vx-card>
</template>
