<template>
  <vx-card title="Basic" code-toggler>
    ...
    <vx-input-group class="mb-base">
      <template slot="prepend">
        <div class="prepend-text bg-primary">
          <span>https://Motivate-Soft.com/users/</span>
        </div>
      </template>
    ...
    <template slot="codeContainer">
      ...
      bg-primary&quot;&gt;
      &lt;span&gt;https://Motivate-Soft.com/users/&lt;/span&gt; &lt;/div&gt;
      &lt;/template&gt; &lt;vs-input v-model=&quot;siteUsername&quot; /&gt;
      &lt;/vx-input-group&gt; &lt;!-- /USERNAME --&gt; &lt;!-- currency --&gt;
      &lt;vx-input-group class=&quot;mb-base&quot;&gt; &lt;template
      slot=&quot;prepend&quot;&gt; &lt;div class=&quot;prepend-text
      bg-primary&quot;&gt; &lt;span&gt;$&lt;/span&gt; &lt;/div&gt;
      &lt;/template&gt; &lt;vs-input v-model=&quot;amount&quot; /&gt;
      &lt;template slot=&quot;append&quot;&gt; &lt;div class=&quot;append-text
      bg-primary&quot;&gt; &lt;span&gt;.00&lt;/span&gt; &lt;/div&gt;
      &lt;/template&gt; &lt;/vx-input-group&gt; &lt;!-- /currency --&gt; &lt;!--
      Textarea --&gt; &lt;vx-input-group&gt; &lt;template
      slot=&quot;prepend&quot;&gt; &lt;div class=&quot;prepend-text
      bg-primary&quot;&gt; &lt;span&gt;Description&lt;/span&gt; &lt;/div&gt;
      &lt;/template&gt; &lt;vs-textarea v-model=&quot;textarea&quot; /&gt;
      &lt;/vx-input-group&gt; &lt;!-- /Textarea --&gt; &lt;/tempalte&gt;
      &lt;script&gt; export default { data() { return { title: &apos;&apos;,
      username: &apos;&apos;, siteUsername: &apos;&apos;, amount: &apos;&apos;,
      textarea: &apos;&apos;, } } } &lt;/script&gt;
    </template>
  </vx-card>
</template>
