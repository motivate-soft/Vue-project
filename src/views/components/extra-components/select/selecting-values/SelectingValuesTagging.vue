...
<template>
  <vx-card title="Tagging" code-toggler no-shadow card-border>
    <div>
      <p class="mb-3">
        To allow input that's not present within the options, set the taggable
        prop to true. If you want new tags to be pushed to the options list, set
        push-tags to true
      </p>
      <br />
      ...
      <small class="muted"
        >Try adding a tag and removing it. It'll still be present within the
        options list.</small
      >
    </div>

    <template slot="codeContainer">
      &lt;template&gt; &lt;h6&gt;Vue Select - Taggable&lt;/h6&gt; &lt;v-select
      taggable :dir=&quot;$vs.rtl ? 'rtl' : 'ltr'&quot; /&gt;&lt;br&gt;
      &lt;h6&gt;Vue Select - Taggable &amp;amp; Push-Tags&lt;/h6&gt;
      &lt;v-select taggable push-tags :dir=&quot;$vs.rtl ? 'rtl' : 'ltr'&quot;
      /&gt; &lt;/template&gt; &lt;script&gt; import vSelect from 'vue-select'
      export default{ data() { return { options: [] } }, components: {
