...
<template>
  <vx-card title="Theme Bubble" code-toggler>
    ...
    <template slot="codeContainer">
      ...
      &lt;/template&gt; &lt;script&gt; // require styles import
      'quill/dist/quill.core.css' import 'quill/dist/quill.snow.css' import
      'quill/dist/quill.bubble.css' import { quillEditor } from
      'vue-quill-editor' export default { data() { return { editorOption: {
      theme: 'bubble', }, content: `...`, } }, components: { quillEditor, } }
      &lt;/script&gt;
    </template>
  </vx-card>
</template>
