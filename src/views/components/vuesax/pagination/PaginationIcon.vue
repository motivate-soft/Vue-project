...
<template>
  <vx-card title="Icon" code-toggler>
    <p>
      ...
      prev-icon and prev-icon directives. By default, their values are
      respectively arrow_back and arrow_forward
    </p>
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;vs-pagination :total=&quot;100&quot;
      v-model=&quot;currentx&quot; :prev-icon=&quot;$vs.rtl ? 'arrow_forward' :
      'arrow_back'&quot; :next-icon=&quot;$vs.rtl ? 'arrow_back' :
      'arrow_forward'&quot; /&gt; &lt;/template&gt; &lt;script&gt; export
      default { data: () =&gt; ({ currentx: 64 }) } &lt;/script&gt;
    </template>
  </vx-card>
</template>
