...
<template>
  <vx-card title="GoTo" code-toggler>
    <p>
      The <code>goto</code> directive will allow users to directly jump to a
      desired page
    </p>

    <vs-alert color="primary" icon="new_releases" active="true" class="mt-5">
      <p>
        If the value given is lower than <strong>1</strong> it will jump to page
        <strong>1</strong>. However if the value is greater than total it will
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;vs-pagination :total=&quot;20&quot;
      v-model=&quot;currentx&quot; goto&gt;&lt;/vs-pagination&gt;
