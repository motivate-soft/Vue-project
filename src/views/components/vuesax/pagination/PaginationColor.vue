...
<template>
  <vx-card title="Color" code-toggler>
    <p>
      You can change the color of the component with the property color, you can
      use the Main colors or RGB and HEX colors
    </p>
    ...
    <template slot="codeContainer">
      ...
      items-center&quot;&gt; &lt;vs-pagination :color=&quot;colorx&quot;
      :total=&quot;20&quot;
      v-model=&quot;currentx&quot;&gt;&lt;/vs-pagination&gt; &lt;input
      class=&quot;input-color ml-4&quot; v-model=&quot;colorx&quot;
      type=&quot;color&quot;&gt; &lt;/div&gt; &lt;/template&gt; &lt;script&gt;
      export default { data: () =&gt; ({ colorx: &apos;#f91f43&apos;, currentx:
      7 }) } &lt;/script&gt;
    </template>
  </vx-card>
</template>
