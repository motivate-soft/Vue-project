...
<template>
  <vx-card title="Color" code-toggler>
    <p>
      You can change the slider's color with the property color. You can also
      add the main <code>colors</code> like: <code>primary</code>,
    ...
    <template slot="codeContainer">
      ...
      v-model=&quot;colorx&quot; name=&quot;&quot; &gt; &lt;vs-slider
      :color=&quot;colorx&quot; v-model=&quot;value1&quot;/&gt;
      &lt;/template&gt; &lt;script&gt; export default { data() { return {
      colorx:'#db7d12', value1:24, } } } &lt;/script&gt;
    </template>
  </vx-card>
</template>
