...
<template>
  <vx-card title="Icon" code-toggler>
    <p>
      You can add an icon with the <code>icon</code> property to better
      representation the sliders to the user
    </p>
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;vs-slider icon=&quot;volume_up&quot; max=10
      v-model=&quot;value1&quot;/&gt; &lt;vs-slider icon=&quot;group_add&quot;
      ticks step=25 v-model=&quot;value2&quot;/&gt; &lt;vs-slider
      icon=&quot;star&quot; ticks max=5 v-model=&quot;value3&quot;/&gt;
      &lt;/template&gt; &lt;script&gt; export default { data() { return {
      value1:6, value2:25, value3:[2,4] } } } &lt;/script&gt;
    </template>
  </vx-card>
</template>
