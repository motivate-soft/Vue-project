...
<template>
  <vx-card title="Background" code-toggler>
    <p>
      If you need to change the background of the loading, you can use the
    ...
    <div class="demo-alignment mt-3">
      ...
      <vs-button @click="openLoadingBackground" type="gradient" color="success"
        >Success</vs-button
      >
    </div>
    ...
    <template slot="codeContainer">
      ...
      class=&quot;demo-alignment&quot;&gt; &lt;input type=&quot;color&quot;
      v-model=&quot;backgroundLoading&quot; name=&quot;&quot;
      value=&quot;&quot;&gt; &lt;vs-button
      @click=&quot;openLoadingBackground&quot; type=&quot;gradient&quot;
      color=&quot;success&quot;&gt;Success&lt;/vs-button&gt; &lt;/div&gt;
      &lt;/template&gt; &lt;script&gt; export default { data() { return {
      backgroundLoading: &apos;#22c16b&apos;, } }, methods: {
      openLoadingBackground() { this.$vs.loading({ background:
      this.backgroundLoading, color: &apos;rgb(255, 255, 255)&apos; })
