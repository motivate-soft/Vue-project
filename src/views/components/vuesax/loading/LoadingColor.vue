...
<template>
  <vx-card title="Color" code-toggler>
    ...
    <div class="demo-alignment mt-3">
      ...
      <vs-button @click="openLoadingColor" type="filled" :color="colorLoading"
        >Loading</vs-button
      >
    </div>
    ...
    <template slot="codeContainer">
      ...
      v-model=&quot;colorLoading&quot; name=&quot;&quot; value=&quot;&quot;&gt;
      &lt;vs-button @click=&quot;openLoadingColor&quot; type=&quot;filled&quot;
      :color=&quot;colorLoading&quot;&gt;Loading&lt;/vs-button&gt; &lt;/div&gt;
      &lt;/template&gt; &lt;script&gt; export default { data() { return {
      colorLoading: &apos;#ff8000&apos;, } }, methods: { openLoadingColor() {
      this.$vs.loading({ color: this.colorLoading }) setTimeout(() =&gt; {
