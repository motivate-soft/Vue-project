...
<template>
  <vx-card title="Automatic" code-toggler>
    <p>
      ...
      <code>Automatic</code> property that executes the shipment by changing the
      value of the <code>input</code>
    </p>
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;vs-upload automatic
      action=&quot;https://jsonplaceholder.typicode.com/posts/&quot;
      @on-success=&quot;successUpload&quot; /&gt; &lt;/template&gt;
      &lt;script&gt; export default { methods:{ successUpload(){
      this.$vs.notify({color:'success',title:'Upload Success',text:'Lorem ipsum
      dolor sit amet, consectetur'}) } } } &lt;/script&gt;
    </template>
  </vx-card>
</template>
