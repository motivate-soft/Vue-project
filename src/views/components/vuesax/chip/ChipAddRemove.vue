...
<template>
  <vx-card title="Add and Remove Items" code-toggler>
    ...
    <template slot="codeContainer">
      ...
      159)&quot; placeholder=&quot;New Element&quot;
      v-model=&quot;chips&quot;&gt; &lt;vs-chip :key=&quot;chip&quot;
      @click=&quot;remove(chip)&quot; v-for=&quot;chip in chips&quot;
      closable&gt; {{ "\{\{ chip \}\}" }}} &lt;/vs-chip&gt; &lt;/vs-chips&gt;
      &lt;/template&gt; &lt;script&gt; export default { data(){ return { chips:[
      &apos;Dribbble&apos;, &apos;GitHub&apos;, &apos;Behance&apos;,
      &apos;Vuejs&apos;, &apos;Vuexy&apos;, ], } }, methods: { remove (item) {
