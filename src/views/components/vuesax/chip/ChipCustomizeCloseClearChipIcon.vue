...
<template>
  <vx-card title="Customize Close and Clear Chips Icons" code-toggler>
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;div class=&quot;op-block mb-4&quot;&gt;
      {{ "\{\{ chips \}\}" }} &lt;/div&gt; &lt;vs-chips color=&quot;rgb(145, 32,
      159)&quot; placeholder=&quot;New Element&quot; v-model=&quot;chips&quot;
      icon-pack=&quot;feather&quot; remove-icon=&quot;icon-trash-2&quot;&gt;
      &lt;vs-chip :key=&quot;chip&quot; @click=&quot;remove(chip)&quot;
      v-for=&quot;chip in chips&quot; closable icon-pack=&quot;feather&quot;
      close-icon=&quot;icon-trash-2&quot;&gt;
      {{ "\{\{ chip \}\}" }}
      &lt;/vs-chip&gt; &lt;/vs-chips&gt; &lt;/template&gt; &lt;script&gt; export
      default { data(){ return { chips:[ &apos;Dribbble&apos;,
      &apos;GitHub&apos;, &apos;Behance&apos;, &apos;Vuejs&apos;,
      &apos;Vuexy&apos;, ], } }, methods: { remove (item) {
