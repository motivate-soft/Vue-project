...
<template>
  <vx-card title="Confirm" code-toggler>
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;vs-button @click=&quot;openConfirm()&quot;
      color=&quot;danger&quot; type=&quot;gradient&quot;&gt;Delete
      Image&lt;/vs-button&gt; &lt;/template&gt; &lt;script&gt; export default {
      data: () =&gt; ({ activeConfirm: false }), methods: { openConfirm() {
      this.$vs.dialog({ type: 'confirm', color: 'danger', title: `Confirm`,
      text: 'Cake sesame snaps cupcake gingerbread danish I love gingerbread.
      Apple pie pie jujubes chupa chups.', accept: this.acceptAlert }) },
      acceptAlert() { this.$vs.notify({ color: 'danger', title: 'Deleted image',
