...
<template>
  <vx-card title="Avatar" code-toggler>
    <p>
      ...
      <code>slot="avatar"</code> by putting a [vs-avatar] component
    </p>
    ...
    <template slot="codeContainer">
      &lt;vs-list&gt; &lt;vs-list-header title=&quot;Users&quot;
      color=&quot;danger&quot;&gt;&lt;/vs-list-header&gt; &lt;vs-list-item
      title=&quot;Steve Jobes&quot; subtitle=&quot;Top Contributor&quot;&gt;
      ...
      title=&quot;Xian Famous Foods&quot; subtitle=&quot;A taste of
      Shaanxi&apos;s delicious culinary traditions, with delights like spicy
      cold noodles and lamb burgers.&quot;&gt; &lt;template
      slot=&quot;avatar&quot;&gt; &lt;vs-avatar vs-text=&quot;Vue&quot;/&gt;
      &lt;/template&gt; &lt;/vs-list-item&gt; &lt;/vs-list&gt;
    </template>
  </vx-card>
</template>
