...
<template>
  <vx-card title="Default" code-toggler>
    ...
    <div class="demo-alignment">
      <vs-button @click="popupActive = true" color="primary" type="filled"
    ...
    <template slot="codeContainer">
      ...
      color=&quot;primary&quot; type=&quot;border&quot;&gt;Open Default
      popup&lt;/vs-button&gt; &lt;vs-popup class=&quot;holamundo&quot;
      title=&quot;Lorem ipsum dolor sit amet&quot;
      :active.sync=&quot;popupActive&quot;&gt; &lt;p&gt; Lorem ipsum dolor sit
      amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
      labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
      exercitation ullamco laboris nisi ut aliquip ex ea commodo
      consequat.&lt;/p&gt; &lt;/vs-popup&gt; &lt;/div&gt; &lt;/template&gt;
      &lt;script&gt; export default { data() { return { popupActive: false, } }
      } &lt;/script&gt;
    </template>
  </vx-card>
</template>
