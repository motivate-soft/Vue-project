...
<template>
  <vx-card title="Fullscreen" code-toggler>
    ...
    <div class="demo-alignment">
      <vs-button @click="popupActive = true" color="primary"
        >Open fullscreen popup</vs-button
      >
    ...
    <template slot="codeContainer">
      ...
      color=&quot;primary&quot;&gt;Open fullscreen popup&lt;/vs-button&gt;
      ...
      default { data() { return { popupActive: false, } } } &lt;/script&gt;
    </template>
  </vx-card>
</template>
