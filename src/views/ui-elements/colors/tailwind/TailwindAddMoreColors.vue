...
<template>
  <vx-card title="Add more colors" no-shadow card-border>
    <p>
      You can add more colors in <code>tailwind.js</code> file. You can find
      this file in root folder.
    </p>
    <span class="mb-5"
      >Checkout Color Customization in
      <a
    ...
    <vs-alert color="primary" icon="new_releases" active="true" class="mt-5">
      <span
        >After registering color you can use <code>text-secondary</code> and
        <code>bg-secondary</code> in theme</span
      >
    </vs-alert>
  </vx-card>
</template>
