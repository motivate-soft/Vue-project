...
<template>
  <vx-card title="Text Classes" code-toggler no-shadow card-border>
    <span
      >You can use <code>text-{color}</code> for applying default colors to
      text.</span
    >
    <br />
    <span
      >There is also other tailwind classes like <code>text-white</code>,
      <code>text-black</code>, <code>text-transparent</code></span
    >
    ...
    <template slot="codeContainer">
      ...
      class=&quot;text-primary&quot;&gt;primary&lt;/span&gt; &lt;span
      ...
      class=&quot;text-white op-block&quot;&gt;white&lt;/span&gt; &lt;span
      class=&quot;text-black&quot;&gt;black&lt;/span&gt; &lt;span
      class=&quot;text-transparent op-block&quot;&gt;transparent&lt;/span&gt;
      &lt;/div&gt;
    </template>
  </vx-card>
</template>
