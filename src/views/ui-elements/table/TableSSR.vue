...
<template>
  <vx-card title="SSR" code-toggler>
    <p>
      To create table with SSR support just add <code>sst</code> prop and then
      handle appropriate events like searching, sorting & pagination.
    </p>
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;vs-table :sst=&quot;true&quot;
      @search=&quot;handleSearch&quot; @change-page=&quot;handleChangePage&quot;
      @sort=&quot;handleSort&quot; v-model=&quot;selected&quot; pagination
      max-items=&quot;3&quot; search :data=&quot;users&quot;&gt; &lt;template
      slot=&quot;header&quot;&gt; &lt;h3&gt;Users&lt;/h3&gt; &lt;/template&gt;
      &lt;template slot=&quot;thead&quot;&gt; &lt;vs-th
      sort-key=&quot;email&quot;&gt;Email&lt;/vs-th&gt; &lt;vs-th
      sort-key=&quot;username&quot;&gt;Name&lt;/vs-th&gt; &lt;vs-th
      sort-key=&quot;website&quot;&gt;Website&lt;/vs-th&gt; &lt;vs-th
      sort-key=&quot;id&quot;&gt;Nro&lt;/vs-th&gt; &lt;/template&gt;
      &lt;template slot-scope=&quot;{data}&quot;&gt; &lt;vs-tr
      :data=&quot;tr&quot; :key=&quot;indextr&quot; v-for=&quot;(tr, indextr) in
      data&quot;&gt; &lt;vs-td :data=&quot;data[indextr].email&quot;&gt;
      {{ "\{\{ data[indextr].email \}\}" }}
      ...
      selected:[], log: [], users:[ { &quot;id&quot;: 1, &quot;name&quot;:
      &quot;Leanne Graham&quot;, &quot;username&quot;: &quot;Bret&quot;,
      &quot;email&quot;: &quot;Sincere@april.biz&quot;, &quot;website&quot;:
      ...
      &quot;ambrose.net&quot;, } ] }), methods:{ handleSearch(searching) {
      console.log(`The user searched for: ${searching}`) },
      handleChangePage(page) { console.log(`The user changed the page to:
      ${page}`) }, handleSort(key, active) { console.log(`the user ordered:
      ${key} ${active}`) } } } &lt;/script&gt;
    </template>
  </vx-card>
</template>
