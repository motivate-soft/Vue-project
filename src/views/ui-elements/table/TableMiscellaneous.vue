...
<template>
  <vx-card title="Miscellaneous" code-toggler>
    <p>
      You can add a
      <strong>filtered, sorted, paginated and multi selected</strong> table with
      combination of the <code>search</code>, <code>multiple</code> and
      <code>pagination</code> properties for example
    </p>
    <br />
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;vs-table multiple v-model=&quot;selected&quot;
      pagination max-items=&quot;3&quot; search :data=&quot;users&quot;&gt;
      ...
      &lt;pre&gt; {{ "\{\{ selected \}\}" }} &lt;/pre&gt; &lt;/template&gt;
      &lt;script&gt; export default { data() { return { selected: [],
      'tableList': [ 'vs-th: Component', 'vs-tr: Component', 'vs-td: Component',
      'thread: Slot', 'tbody: Slot', 'header: Slot' ], users: [ {
