...
<template>
  <vx-card title="Single Selected" code-toggler>
    <p>
      You can add the functionality of select a specific <strong>tr</strong> to
      do this add the property <code>data</code> with the value to be selected,
      it is usually the triterated
    </p>

    <vs-alert color="primary" icon="new_releases" active="true" class="mt-3">
      <p>
        if you need to execute a certain function to select the user, we have
        the property <code>@selected</code>, as the first parameter the data is
        returned
      </p> </vs-alert
    ><br />
    ...
    <template slot="codeContainer">
      &lt;template&gt; &lt;vs-table v-model=&quot;selected&quot;
      @selected=&quot;handleSelected&quot; :data=&quot;users&quot;&gt;
      &lt;template slot=&quot;thead&quot;&gt; &lt;vs-th&gt;Email&lt;/vs-th&gt;
      ...
      selected: [], users: [.....], } }, methods: { handleSelected(tr) {
      this.$vs.notify({ title: `Selected ${tr.username}`, text: `Email:
      ${tr.email}` }) } } } &lt;/script&gt;
    </template>
  </vx-card>
</template>
