...
const data = {
  Motivate-Soft_product_1: {
    img: require("@/assets/images/pages/content-img-1.jpg"),
    title: "Vuexy Admin",
    subtitle: "By Motivate-Soft Creative Studio",
    subtitle_2: "Elite Author",
  },
  Motivate-Soft_product_sales_1: {
...
mock.onGet("/api/users/Motivate-Soft/product/1").reply(() => {
  return [200, data.Motivate-Soft_product_1];
});

mock.onGet("/api/users/Motivate-Soft/product/sales/1").reply(() => {
  return [200, data.Motivate-Soft_product_sales_1];
});

mock.onGet("/api/users/Motivate-Soft/product/goals/1").reply(() => {
  return [200, data.Motivate-Soft_product_goal_1];
});
